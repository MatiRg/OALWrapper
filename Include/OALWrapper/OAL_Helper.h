...
#define FUNC_USES_AL  [[maybe_unused]] bool bALError = false; ClearALErrors(sFuncName);
#define FUNC_USES_ALC [[maybe_unused]] bool bALCError = false; ClearALCErrors(sFuncName);

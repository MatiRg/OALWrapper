...
public:
    cOAL_Init_Params() : msDeviceName(""),
                         ...
                         mlStreamingBufferSize(524288),
                         mlStreamingBufferCount(2),
                         mbUseEFX(false),
                         mlNumSlotsHint(4),
                         mlNumSendsHint(4),
                         mlSlotUpdateFreq(15)
...
/*bool	OAL_Init (	const char* asDeviceName = nullptr, int alOutputFreq = 44100,
